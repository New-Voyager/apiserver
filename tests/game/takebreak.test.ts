...
import {buyIn, configureGame, configureGameQuery, createGameServer, joinGame, sitBack, startGame} from '../game/utils';
...
describe('takeBreak APIs', () => {
  ...
  test('sit back after break', async () => {
    ...
    await sitBack({ ownerId: playerId, location: {
      lat: 100,
      long: 100,
    }, gameCode})
    // hand num 2
