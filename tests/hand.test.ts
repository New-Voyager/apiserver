...
describe('Hand Server', () => {
  ...
  test('Get latest hand history', async () => {
    ...
    try {
	  const resp1 = await handutils.getLastHandHistory(playerId, clubId, game1.gameId);
  ...
  test('Get all hand history', async () => {
    ...
    try {
      const resp1 = await handutils.getAllHandHistory(playerId, clubId, game1.gameId);
  ...
  test('Get all hand history pagination', async () => {
    ...
    const resp2 = await handutils.getAllHandHistory(playerId, clubId, game1.gameId, {
  ...
  test('Get specific hand history', async () => {
	...
	await axios.post(`${HANDSERVER_API}/save-hand`, handData);
	const resp = await handutils.getSpecificHandHistory(playerId, clubId, game1.gameId, '1');
