export const server = 'http://localhost:9501';
export const deleteClubByName = '/internal/delete-club-by-name';
export const authLogin = '/auth/login';
export const registerGameServer = '/internal/register-game-server';
