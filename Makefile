...
GAME_SERVER_IMAGE := $(REGISTRY)/game-server:0.7.79-tournament
BOTRUNNER_IMAGE := $(REGISTRY)/botrunner:0.7.61-tournament
TIMER_IMAGE := $(REGISTRY)/timer:0.5.12-tournament
SCHEDULER_IMAGE := $(REGISTRY)/scheduler:0.1.13-tournament
